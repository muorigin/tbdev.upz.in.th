...
#VIDEOFORMATS
'videoformats_title' => "Downloaded a movie and don't know what CAM/TS/TC/SCR means?",
...
'videoformats_cam_body' => "
    ...
    fairly empty and a fairly clear signal will be heard.<br /><br />",
...
'videoformats_telesync_body' => "
    ...
    are CAMs that have been mislabeled.<br /><br />",
...
'videoformats_telecine_body' => "
    ...
    TimeCode , which is a visible counter on screen throughout the film.<br /><br />",
...
'videoformats_screener_body' => "
    ...
    some looking better than others.<br /><br />",
...
'videoformats_dvdscreener_body' => "
    ...
    Usually transferred to SVCD or DivX/XviD.<br /><br />",
...
'videoformats_vhsrip_body' => "Transferred off a retail VHS, mainly skating/sports videos and XXX releases.<br /><br />",
...
'videoformats_tvrip_body' => "
    ...
    rips are all supported by the TV scene.<br /><br />",
...
'videoformats_workprint_body' => "
    ...
    additions to the collection once a good quality final has been obtained.<br /><br />",
...
'videoformats_watermarks_body' => "
    ...
    of the corners. Most famous are the 'Z' 'A' and 'Globe' watermarks.<br /><br />",
...
'videoformats_proper_body' => "
    ...
    PROPER should always be included in the NFO.<br /><br />",
...
'videoformats_limited_body' => "
    ...
    250 theaters, generally smaller films (such as art house films) are released as limited.<br /><br />",
...
'videoformats_internal_body' => "
    ...
    context to the usual definition.<br /><br />",

'videoformats_stv' => "<b>STV -</b>",
'videoformats_stv_body' => "Straight To Video. Was never released in theaters, and therefore a lot of sites do not allow these.<br /><br />",

'videoformats_aspect' => "<b>ASPECT RATIO TAGS -</b>",
'videoformats_aspect_body' => "These are *WS* for widescreen (letterbox) and *FS* for Fullscreen.<br /><br />",

'videoformats_repack' => "<b>REPACK -</b>",
'videoformats_repack_body' => "If a group releases a bad rip, they will release a Repack which will fix the problems.<br /><br />",
...
'videoformats_nuked_body' => "
    ...
    <b>INTERLACED</b> = black lines on movement as the field order is incorrect.<br /><br />",

'videoformats_dupe' => "<b>DUPE -</b>",
'videoformats_dupe_body' => "Dupe is quite simply, if something exists already, then theres no reason for it to exist again without proper reason.<br />",
